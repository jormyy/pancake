...
const styles = StyleSheet.create({
  ...
  input: {
    flex: 1, fontSize: 15, color: '#111', fontWeight: '500',
    borderBottomWidth: 1.5, borderBottomColor: '#F97316', padding: 0,
  },

  actionRow: { flexDirection: 'row', gap: 12 },
  editButton: {
    backgroundColor: '#fff', borderRadius: 12, height: 48,
    justifyContent: 'center', alignItems: 'center',
  ...
  saveButton: {
    flex: 1, backgroundColor: '#F97316', borderRadius: 12, height: 48,
    justifyContent: 'center', alignItems: 'center',
  },
  saveButtonText: { color: '#fff', fontWeight: '700', fontSize: 15 },
  cancelButton: {
    flex: 1, backgroundColor: '#fff', borderRadius: 12, height: 48,
    justifyContent: 'center', alignItems: 'center',
    borderWidth: 1, borderColor: '#ddd',
  },
