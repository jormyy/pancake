            ...
            <View style={styles.matchupSection}>
                {matchupLoading ? (
                    ...
                    <View style={styles.noMatchup}>
                        ...
                        <Text style={styles.noMatchupSub}>
                            Matchups are generated before each week starts.
                        </Text>
                    </View>
                )}
            </View>
        ...
        <View style={styles.matchupCard}>
            ...
            <View style={styles.matchupScores}>
                ...
                <View
                    style={[
                        styles.matchupSide,
                        iWinning && !matchup.isFinalized && styles.winningSide,
                    ]}
                >
