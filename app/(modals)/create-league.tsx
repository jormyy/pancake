...
export default function CreateLeagueScreen() {
  ...
  function handleShare() {
    Share.share({ message: `Join my dynasty basketball league on Pancake! Invite code: ${inviteCode}` })
  }
...
const styles = StyleSheet.create({
  ...
  codeBox: {
    ...
    borderRadius: 16, paddingVertical: 24, paddingHorizontal: 40, marginVertical: 8,
  },
  codeText: { fontSize: 36, fontWeight: '800', color: '#F97316', letterSpacing: 8 },
  shareButton: {
    width: '100%', height: 52, backgroundColor: '#F97316',
    borderRadius: 12, justifyContent: 'center', alignItems: 'center',
  },
  shareButtonText: { color: '#fff', fontWeight: '700', fontSize: 16 },
  doneButton: {
    width: '100%', height: 52, borderWidth: 1.5, borderColor: '#ddd',
    borderRadius: 12, justifyContent: 'center', alignItems: 'center',
  },
