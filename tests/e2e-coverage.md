...
| D.X.2 realtime bid/score events | FAIL | Realtime mode opens multiple Supabase Realtime clients and asserts a matchups update reaches every client within 2s. |
...
| 10 seasons and continue past 10 / 20 clean | PENDING | Current run status is ERROR for target 1 season(s). |
