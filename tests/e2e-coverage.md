...
- Finished: 2026-05-12T04:24:25.887Z
- Target seasons: 10
...
| D.LONG.3/D.LONG.4 standings/champion history | PENDING | No prior-season standings/champion rollup assertion implemented. |
...
| D.LONG.7 memory/connection leaks | FAIL | Harness memory metrics live in tests/artifacts/perf-metrics.json; current invariant run exceeds default memory drift gate. |
| 10 seasons and continue past 10 / 20 clean | PENDING | Current run status is FAIL for target 10 season(s). |
