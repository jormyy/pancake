...
describe('logic hardening source guards - draft, auction, roster history', () => {
    ...
    it('keeps rookie timeout behavior configurable and server-enforced', () => {
        ...
        expect(leagueDraftPanels).toContain('Timeout behavior')
        expect(leagueDraftPanels).toContain('ROOKIE_TIMER_EXPIRY_BEHAVIORS')
    ...
    it('supports configurable real drafts and side-effect-free mock drafts', () => {
        ...
        expect(leagueDraftPanels).toContain('Create Room')
        expect(leagueState).toContain('OPEN_DRAFT_STATUSES')
        expect(leagueState).toContain('getJoinableDraft')
        expect(leagueDraftPanels).toContain('Resolve Rookie Draft')
        ...
        expect(leagueDraftPanels).toContain('activeDraftButtonLabel')
        expect(leagueDraftPanels).toContain("draft.isMock ? 'Mock ' : ''")
        expect(leagueDraftPanels).toContain('activeDraft.draftType === \'snake\' && !activeDraft.isMock && isCommissioner')
