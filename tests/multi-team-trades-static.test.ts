...
describe('multi-team trade UI and client mapping', () => {
    ...
    it('exposes a multi-team composer and participant-aware trade card actions', () => {
        ...
        expect(multiTeamComposer).toContain('participantPlayerDestinationIds')
        expect(multiTeamComposer).toContain('participantPickDestinationIds')
        expect(multiTeamComposer).toContain('setParticipantDestination')
        expect(multiTeamComposer).toContain('setParticipantPlayerDestination')
        expect(multiTeamComposer).toContain('setParticipantPickDestination')
        expect(multiTeamComposer).toContain('prefillFromTrade')
        expect(multiTeamComposer).toContain('buildMultiTeamItems')
        expect(multiTeamComposer).toContain('destinationFor(memberId, ids)')
        expect(multiTeamComposer).toContain('itemDestinationFor')
        ...
        expect(composer).toContain('prefillMultiTeamTrade(trade, myMemberId)')
        ...
        expect(composer).toContain('participantPlayerDestinationIds={multiTeam.participantPlayerDestinationIds}')
        expect(composer).toContain('participantPickDestinationIds={multiTeam.participantPickDestinationIds}')
        expect(composer).toContain('onDestinationChange={multiTeam.setParticipantDestination}')
        expect(composer).toContain('onPlayerDestinationChange={multiTeam.setParticipantPlayerDestination}')
        expect(composer).toContain('onPickDestinationChange={multiTeam.setParticipantPickDestination}')
        expect(composer).toContain('proposeMultiTeamTrade')
        expect(multiTeamBuilder).toContain('MultiTeamTradeOverview')
        expect(multiTeamBuilder).toContain('BUILD THE DEAL')
        ...
        expect(multiTeamBuilder).toContain('activeParticipantId')
        ...
        expect(multiTeamBuilder).toContain('SELECTED ROUTES')
        expect(multiTeamBuilder).toContain('onPlayerDestinationChange(memberId, playerId, destinationId)')
        expect(multiTeamBuilder).toContain('onPickDestinationChange(memberId, pick.pickId, destinationId)')
        expect(multiTeamOverview).toContain('DEAL OVERVIEW')
        expect(multiTeamOverview).toContain('participantLabels.get(item.fromMemberId)')
        expect(multiTeamOverview).toContain('No incoming assets')
        expect(multiTeamOverview).toContain('outgoingCount')
        ...
        expect(tradeCard).toContain('const incoming = trade.routedItems.filter')
        expect(tradeCard).toContain('participant.acceptedAt')
        expect(tradeCard).toContain('From {tradeMemberLabel(trade, item.fromMemberId, myMemberId)}')
        ...
        expect(tradeCard).toContain("params: { counterTradeId: trade.id }")
        expect(tradeCard).toContain("params: { editTradeId: trade.id }")
