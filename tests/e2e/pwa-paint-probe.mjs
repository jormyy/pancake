...
export const runPaintProbe = async (options = {}) => {
  ...
  const lines = [
    ...
    '| # | mode | status | bucket | reason | prelude | setup opens (attempts; 3 = one per prelude page) | measured nav attempts | early observer | paint (early) | paint (byType) | paint (late observer) | shell ms | mount ms | visible | focus | nav |', '| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |',
