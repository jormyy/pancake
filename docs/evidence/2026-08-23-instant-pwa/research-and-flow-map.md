...
| [ESPN free-agent guide](https://support.espn.com/hc/en-us/articles/360058028831-How-to-add-a-player) | The path starts in Players. Add and Claim use distinct states. A required drop appears before confirmation. | ADOPT the Players entry and state-specific action. Keep server checks before a roster write. |
