...
- Status: PASS
- Generated: 2026-08-23T17:45:10.513Z

| Source | Status | Freshness | Completeness | Failures | Recovery |
| --- | --- | --- | --- | --- | --- |
| nba-cdn | PASS | pass: sync-schedule latest=success, age=0.1h, rows=1225. source:nba-cdn-scoreboard latest=success, age=0.1h, rows=0. sync-stats latest=success, age=0.1h, rows=0. sync-players latest=success, age=0.1h, rows=599. | pass: season=2027, games=1200, weeks=25, finals_missing_stats=0/0, nba_ids=642. | pass: Latest schedule, scoreboard, box-score, and player-index attempts are successful. | pass: Down, non-JSON, reshaped, and next-good NBA CDN requests pass the degraded-source suite. |
| espn-public-json | PASS | pass: sync-players latest=success, age=0.1h, rows=599. | pass: espn_ids=614, news=94, latest_news_age=30.6h. | pass: Latest player, team, position, injury, and news attempt is success; errors are retained in sync_runs. | pass: A live 403 failure was recorded, the endpoint changed, and the next local run succeeded. |
...
| hashtag-basketball | PASS | pass: sync-rankings latest=success, age=0.1h, rows=400. | pass: latest points view has 400 rows; fetched_at=2026-08-23T17:41:16.862Z. | pass: Latest ranking attempt is success; row floors and selected-view checks fail closed. | pass: Changed markup returns zero rows; the saved valid response parses after the degraded case. |
| nba-draft-order | PASS | pass: sync-draft-order latest=success, age=0.1h, rows=192. | pass: 60 rookies have a verified draft number. | pass: Latest draft attempt is success; incomplete boards preserve prior data. | pass: A failed window day preserves prior data; the next valid day writes and verifies all picks. |
