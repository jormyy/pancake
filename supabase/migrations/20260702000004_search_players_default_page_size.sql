-- Keep direct search_players RPC callers on the same first-page budget as the
-- app. Migration 20260702000001 already exists in prod, so this follow-up
-- reapplies the function with the final 20-row default.
