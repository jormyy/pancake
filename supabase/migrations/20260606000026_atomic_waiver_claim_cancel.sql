...
REVOKE ALL ON FUNCTION public.cancel_waiver_claim_atomic(uuid, uuid, uuid) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.cancel_waiver_claim_atomic(uuid, uuid, uuid) FROM anon;
REVOKE ALL ON FUNCTION public.cancel_waiver_claim_atomic(uuid, uuid, uuid) FROM authenticated;
GRANT EXECUTE ON FUNCTION public.cancel_waiver_claim_atomic(uuid, uuid, uuid) TO service_role;
