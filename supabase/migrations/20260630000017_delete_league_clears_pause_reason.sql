-- Prod had already recorded league deletion before drafts.pause_reason existed.
-- Replay only this affected RPC so cancelled drafts do not retain paused-only
-- state after league deletion.
