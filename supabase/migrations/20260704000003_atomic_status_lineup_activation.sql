...
REVOKE ALL ON FUNCTION public.activate_roster_player_with_lineup_atomic(uuid, text, uuid, text, uuid, uuid, uuid, date, int, roster_slot_type) FROM PUBLIC, anon;
GRANT EXECUTE ON FUNCTION public.activate_roster_player_with_lineup_atomic(uuid, text, uuid, text, uuid, uuid, uuid, date, int, roster_slot_type) TO authenticated, service_role;
