...
REVOKE ALL ON FUNCTION public.toggle_ir_atomic(uuid, boolean, uuid) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.toggle_ir_atomic(uuid, boolean, uuid) FROM anon;
REVOKE ALL ON FUNCTION public.toggle_ir_atomic(uuid, boolean, uuid) FROM authenticated;
GRANT EXECUTE ON FUNCTION public.toggle_ir_atomic(uuid, boolean, uuid) TO service_role;
