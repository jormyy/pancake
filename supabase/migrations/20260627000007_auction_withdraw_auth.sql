-- Auction withdrawal authorization hardening:
-- withdraw_auction_nomination_atomic is a manager-consent action and must
-- require caller ownership at the RPC layer, matching nominate/bid.

DROP FUNCTION IF EXISTS public.withdraw_auction_nomination_atomic(uuid, uuid, uuid);
