-- Prod replay for projects that recorded earlier dynasty ranking migrations
-- while this branch was under review. Keep the active 7-argument
-- replace_dynasty_rankings RPC body append-only so Edge sync-rankings and the
-- linked database cannot drift.
