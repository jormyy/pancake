-- Dynasty transactions/trade release: weekly add limits and FAAB waivers.
...
DROP FUNCTION IF EXISTS public.create_waiver_claim_atomic(uuid, uuid, uuid, uuid, uuid);
...
REVOKE ALL ON FUNCTION public.add_free_agent_atomic(uuid, uuid, uuid) FROM PUBLIC, anon;
GRANT EXECUTE ON FUNCTION public.add_free_agent_atomic(uuid, uuid, uuid) TO authenticated, service_role;

REVOKE ALL ON FUNCTION public.create_waiver_claim_atomic(uuid, uuid, uuid, uuid, uuid, int, int) FROM PUBLIC, anon, authenticated;
GRANT EXECUTE ON FUNCTION public.create_waiver_claim_atomic(uuid, uuid, uuid, uuid, uuid, int, int) TO service_role;

REVOKE ALL ON FUNCTION public.edit_waiver_claim_atomic(uuid, uuid, uuid, uuid, int, int) FROM PUBLIC, anon, authenticated;
GRANT EXECUTE ON FUNCTION public.edit_waiver_claim_atomic(uuid, uuid, uuid, uuid, int, int) TO service_role;

REVOKE ALL ON FUNCTION public.reorder_waiver_claim_atomic(uuid, uuid, uuid, text) FROM PUBLIC, anon, authenticated;
GRANT EXECUTE ON FUNCTION public.reorder_waiver_claim_atomic(uuid, uuid, uuid, text) TO service_role;

REVOKE ALL ON FUNCTION public.process_next_waiver_claim_atomic(date) FROM PUBLIC, anon, authenticated;
